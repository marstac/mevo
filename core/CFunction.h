...
#include "../interfaces/ICFunction.h"
#include "../interfaces/ICProblem.h"

namespace MEVO {
class CFunction : public ICFunction
{
public:
    CFunction();
    CFunction(ICProblem* _p);
    ...
    */
    ...
    /** This method is called by an evaluator object. Calls calculate function and sets an evaluated function value in a problem object.
        ...
        @return double value of a calucated objective function
     */
    virtual double evaluate(double* _pf, unsigned int _nf, int* _pi, unsigned int _ni);
