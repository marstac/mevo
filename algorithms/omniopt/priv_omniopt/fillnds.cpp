...
void OmniOptimizer::fill_nondominated_sort (OmniOptimizer::population *mixed_pop, OmniOptimizer::population *new_pop)
{
    std::deque<double>* epsilon = NULL;
    ...
    do
    {
        ...
        do
        {
            ...
            do
            {
                ...
                flag = mixed_pop->ind[temp1->index]->checkDominance(mixed_pop->ind[temp2->index], epsilon);
                if (flag == 1)
                {
...
void OmniOptimizer::crowding_fill (OmniOptimizer::population *mixed_pop, OmniOptimizer::population *new_pop, int count, int front_size, list *elite)
{
    int *dist;
    list *temp;
    int i, j;
