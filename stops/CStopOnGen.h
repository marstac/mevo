...
namespace MEVO {
class CStopOnGen : public ICStop
{
public:
    /** Constructor */
    CStopOnGen();
    ...
    */
    ...
    /** Function sets maximum generations allowed for an algorithm.
      After specified number of generations algorithm will stop.
        @param _g maximum generations allowed for an algorithm
    */
    void setMaxGenerations(unsigned int _g);

    /** Function returns maximum generations allowed for an algorithm.
        @return maximum generations allowed for an algorithm
    */
