#ifndef CONEPOINTCROSSOVER_H
#define CONEPOINTCROSSOVER_H
...
/** Provides functions for one point crossover.
  */
class COnePointCrossover : virtual public CCrossover
{
public:
